...
def setup_enemy(level):
    ...
    if level == 1:
        ...
        enemies = [
            {"name": "哥布林", "hp": 120, "max_hp": 120, "atk": 20, "speed": 55, "slot": 0},
            {"name": "哥布林", "hp": 120, "max_hp": 120, "atk": 30, "speed": 60, "slot": 4},
            {"name": "哥布林", "hp": 120, "max_hp": 120, "atk": 20, "speed": 55, "slot": 2},
        ]
        skill_points = 2
    elif level == 3:
        enemies = [
            {"name": "哥布林", "hp": 120, "max_hp": 120, "atk": 30, "speed": 55, "slot": 0},
            {"name": "哥布林", "hp": 120, "max_hp": 120, "atk": 30, "speed": 55, "slot": 4},
